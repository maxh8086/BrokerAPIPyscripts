...
APP_ID =  "MHBXCS6SSB3" # App ID from myapi dashboard is in the form appId-appType. Example - EGNI8CE27Q-100, In this code EGNI8CE27Q will be APP_ID and 100 will be the APP_TYPE
APP_TYPE = "100"
SECRET_KEY = '0NDCYDDD'
client_id= f'{APP_ID}-{APP_TYPE}'

FY_ID = "FZ1235"  # Your fyers ID
APP_ID_TYPE = "2"  # Keep default as 2, It denotes web login
TOTP_KEY = "FGHJKLSSC2DMDJDIMPBXBZK5B3G4J"  # TOTP secret is generated when we enable 2Factor TOTP from myaccount portal
